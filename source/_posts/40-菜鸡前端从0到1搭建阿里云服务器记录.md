...
```
docker run -p 3306:3306 --name mysql -v /usr/share/zoneinfo/:/usr/share/ -v /usr/share/zoneinfo/:/usr/share/zoneinfo/ -e MYSQL_ROOT_PASSWORD=你的数据库密码 -d --privileged=true --restart=always hub.c.163.com/library/mysql:latest
```
